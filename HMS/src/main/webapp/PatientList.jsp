...
<body class="bg-gradient-to-r from-indigo-100 via-purple-100 to-pink-100 min-h-screen flex items-center justify-center p-8">
    ...
    <h:form styleClass="w-full max-w-6xl bg-white rounded-3xl shadow-2xl p-10 animate-fadeIn">
        ...
        <div class="overflow-x-auto rounded-xl shadow-lg">
            <h:dataTable value="#{hospitalController.showPatient()}" var="p" border="0"
                ...
                <h:column>
                    ...
                    <h:outputText value="#{p.patientId}" styleClass="px-6 py-4 whitespace-nowrap text-gray-700 font-semibold" />
                </h:column>
                ...
                <h:column>
                    ...
                    <h:outputText value="#{p.patientName}" styleClass="px-6 py-4 whitespace-nowrap text-gray-800" />
                </h:column>
