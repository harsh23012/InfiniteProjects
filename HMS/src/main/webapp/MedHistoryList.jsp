...
<body class="bg-gradient-to-r from-indigo-100 via-purple-100 to-pink-100 min-h-screen flex items-center justify-center p-8">
    ...
    <h:form styleClass="w-full max-w-6xl bg-white rounded-3xl shadow-2xl p-10 animate-fadeIn">
        ...
        <div class="overflow-x-auto rounded-xl shadow-lg">
            <h:dataTable value="#{hospitalController.showMedicalHistory()}" var="m" border="0"
                ...
                <h:column>
                    <f:facet name="header">
                        <h:outputLabel value="Med Id" styleClass="px-6 py-3 text-left" />
                    </f:facet>
                    <h:outputText value="#{m.medId}" styleClass="px-6 py-4 whitespace-nowrap text-gray-700 font-semibold" />
                </h:column>
                ...
                <h:column>
                    ...
                    <h:outputText value="#{m.patientId}" styleClass="px-6 py-4 whitespace-nowrap text-gray-700" />
                </h:column>

                <h:column>
                    <f:facet name="header">
                        <h:outputLabel value="Medicines" styleClass="px-6 py-3 text-left" />
                    </f:facet>
                    <h:outputText value="#{m.medicines}" styleClass="px-6 py-4 whitespace-nowrap text-gray-800 " />
                </h:column>

                <h:column>
                    <f:facet name="header">
                        <h:outputLabel value="Tests" styleClass="px-6 py-3 text-left" />
                    </f:facet>
                    <h:outputText value="#{m.tests}" styleClass="px-6 py-4 whitespace-nowrap text-gray-700" />
                </h:column>
