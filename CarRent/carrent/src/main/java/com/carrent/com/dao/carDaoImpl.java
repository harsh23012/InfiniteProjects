...
public class carDaoImpl implements CarDao{
	...
	@Override
	public void addCar(Vehicle vehicle) throws ClassNotFoundException, SQLException {
	...
	@Override
	public void removeCar(String vehicleNumber) throws ClassNotFoundException, SQLException, vehicleNotFoundException {
	...
	@Override
	public List<Vehicle> listCar(String status) throws SQLException, ClassNotFoundException {
	...
	@Override
	public List<Vehicle> findCarById(int vehId) throws SQLException, ClassNotFoundException {
		 List<Vehicle> vehicleList = new ArrayList<>();
