...
<a href="CheckUserNotReturned.jsp">Check User Not Returned Book</a>
</div>
<div class="atwo"style="background-color:#ffff00;margin-top:-30px;margin-left:330px">
<a href="HistoryAllReturnedBook.jsp">History of All Book Returned</a>
</div>
<div class="atwo"style="background-color:#ffff00;margin-top:-30px;margin-left:490px">
<a href="HistoryAllIssuedBook.jsp">History of All Book Issued</a>
</div>
</div>
</body>
</html>